...
$&t_n:=\frac{s\_n}{F\_\mathrm{s}}$, 
$&p_n:=\Delta^\mathrm{A}(s\_n)$, 
$&\Gamma^\mathrm{A}\_{\mathrm{F2E}}(n):= (t\_n, p\_n)$. 
...
<img src="figs/2024-11-11_retrained-op63-garcia.png" alt="system_overview" width="300">
