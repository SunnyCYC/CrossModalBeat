...
<img src="https://hackmd.io/_uploads/SyPDvmGexx.png" alt="system_overview" width="300">
...
\begin{align}
 &t_n:=\frac{s_n}{F_\mathrm{s}}, \\
 &p_n:=\Delta^\mathrm{A}(s_n), \\
 &\Gamma^\mathrm{A}_{\mathrm{F2E}}(n):= (t_n, p_n). \
\end{align}
...
![2024-10-14_acti-pipeline](https://hackmd.io/_uploads/B1LTJvXelx.png)
...
<img src="https://hackmd.io/_uploads/SyCTevXexe.png" alt="system_overview" width="300">
...
![image](https://hackmd.io/_uploads/S1nicDXlgl.png)
